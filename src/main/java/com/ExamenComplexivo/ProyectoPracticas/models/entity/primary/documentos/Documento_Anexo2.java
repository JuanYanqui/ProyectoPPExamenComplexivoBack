...
@NoArgsConstructor
@AllArgsConstructor
@Table(name = "documento_Anexo2")
public class Documento_Anexo2 implements Serializable {
    private static final long serialVersionUID = 1L;
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Long id_documentoAnexo2;

    @Column(name = "documento_anexo2",columnDefinition = "bytea")
    private byte[] documento_anexo2;

    //Relacionado con anexo1 de uno a uno
    @JsonIgnore
    @OneToOne(mappedBy = "documentoAnexo2")
