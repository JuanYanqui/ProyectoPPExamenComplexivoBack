	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		http.cors().and().csrf().disable()
				...
				.authorizeRequests().antMatchers("/swagger-ui/index.html", "/api/auth/**", "/api/docentefenix/{cedula}",
						...
						"/api/solicitudPractica/buscar/**","/api/documentoAsigTutorAcademico/**","/api/documentoAsigTutorEmpresarial/**", "/api/practica/**","/api/documentoAnexo3/**","/api/documentoAnexo2/**").permitAll()
